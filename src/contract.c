...
// Wallets code
const uint8_t safe_multisig_wallet[] = { 0xB5, 0xEE, 0x9C, 0x72, 0x01, 0x02, 0x49, 0x01,
...
const uint8_t safe_multisig_wallet_24h[] = { 0xB5, 0xEE, 0x9C, 0x72, 0x01, 0x02, 0x49, 0x01,
...
const uint8_t setcode_multisig_wallet[] = { 0xB5, 0xEE, 0x9C, 0x72, 0x01, 0x02, 0x65, 0x01,
...
const uint8_t bridge_multisig_wallet[] = { 0xB5, 0xEE, 0x9C, 0x72, 0x01, 0x02, 0x45, 0x01,
...
const uint8_t safe_multisig_2_wallet_code_hash[] = { 0x29, 0xb2, 0x47, 0x76, 0xb3, 0xdf, 0x6a, 0x05,
...
const uint32_t safe_multisig_2_wallet_cell_depth = 0x0C;
...
void get_address(const uint32_t account_number, uint32_t wallet_type, uint8_t* address) {
    switch (wallet_type) {
        ...
        case MULTISIG_2: {
            compute_multisig_address(account_number,
                                     safe_multisig_2_wallet,
                                     sizeof(safe_multisig_2_wallet),
                                     safe_multisig_2_wallet_code_hash,
                                     safe_multisig_2_wallet_cell_depth,
                                     address);
            break;
        }
        case SURF_WALLET: {
